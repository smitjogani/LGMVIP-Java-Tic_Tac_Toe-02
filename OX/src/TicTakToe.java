...
public class TicTakToe {
	...
	private void winningGame() {
		...
		// For Player O
			...
			JOptionPane.showMessageDialog(frame, "Player 0 Win", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
			...
			JOptionPane.showMessageDialog(frame, "Match is draw", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
		}
